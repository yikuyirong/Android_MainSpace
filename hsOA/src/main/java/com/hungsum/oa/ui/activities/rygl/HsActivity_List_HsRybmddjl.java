...
public class HsActivity_List_HsRybmddjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsRybmddjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsRybmddjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsRybmddjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsRybmddjl") ||
		   funcname.equals("DoDatas_Submit_HsRybmddjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsRybmddjl"))
		{
