...
public class HsActivity_List_HsClbmddjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsClbmddjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsClbmddjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsClbmddjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsClbmddjl") ||
		   funcname.equals("DoDatas_Submit_HsClbmddjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsClbmddjl"))
		{
