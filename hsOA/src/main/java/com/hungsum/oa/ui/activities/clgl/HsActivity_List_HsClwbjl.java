...
public class HsActivity_List_HsClwbjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsClwbjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsClwbjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsClwbjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsClwbjl") ||
		   funcname.equals("DoDatas_Submit_HsClwbjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsClwbjl"))
		{
