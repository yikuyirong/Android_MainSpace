...
public class HsActivity_List_HsClxsjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsClxsjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsClxsjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsClxsjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsClxsjl") ||
		   funcname.equals("DoDatas_Submit_HsClxsjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsClxsjl"))
		{
