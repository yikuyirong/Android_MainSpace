...
public class HsActivity_List_HsClbxjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsClbxjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsClbxjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsClbxjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsClbxjl") ||
		   funcname.equals("DoDatas_Submit_HsClbxjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsClbxjl"))
		{
