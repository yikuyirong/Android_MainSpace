...
public class HsActivity_List_HsRyjcjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsRyjcjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsRyjcjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsRyjcjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsRyjcjl") ||
		   funcname.equals("DoDatas_Submit_HsRyjcjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsRyjcjl"))
		{
