...
public class HsActivity_List_HsRyztbhjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsRyztbhjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsRyztbhjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsRyztbhjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsRyztbhjl") ||
		   funcname.equals("DoDatas_Submit_HsRyztbhjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsRyztbhjl"))
		{
