...
public class HsActivity_List_HsClztbhjl extends HsActivity_List_DJ
{
	public HsActivity_List_HsClztbhjl()
	{
		super();
	...
	{
		return ((HSOAWebService)application.getWebService()).showHsClztbhjls(
	...
	{
		Intent intent = new Intent(this,HsActivity_DJ_HsClztbhjl.class);
	...
	public void actionAfterWSReturnData(String funcname, Serializable data)
			throws Exception
	{
		if(funcname.equals("DoDatas_Delete_HsClztbhjl") ||
		   funcname.equals("DoDatas_Submit_HsClztbhjl") ||
		   funcname.equals("DoDatas_UnSubmit_HsClztbhjl"))
		{
