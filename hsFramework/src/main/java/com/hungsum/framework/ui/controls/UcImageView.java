...
public class UcImageView extends ImageView
{
	...
	public UcImageView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}

	public UcImageView(Context context, AttributeSet attrs, int defStyle)
	{
	...
	public void setHsBitmap(HsBitmap bitmap)
	{
		this.setImageBitmap(bitmap.getBitmap());
	}
